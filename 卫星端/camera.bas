...
Public Function CreateCaptureWindow( _
   ...
   Optional nWidth As Long = 640, _
   Optional nHeight As Long = 480, _
...
Public Sub capDlgVideoSource(nCaptureHandle As Long)

      SendMessage nCaptureHandle, WM_CAP_DLG_VIDEOSOURCE, 0, 0

End Sub

Public Sub capDlgVideoFormat(nCaptureHandle As Long)
...
Public Sub capDlgVideoCompression(nCaptureHandle As Long)
